...
- (void)initSDK {
    ...
    _lmzxSDK.lmzxProtocolTextColor = AppButtonbackgroundColor ;
    // 提交按钮颜色
    _lmzxSDK.lmzxSubmitBtnColor = AppButtonbackgroundColor;
    // 页面背景颜色
...
//            * -1 其他异常
            switch (code) {
                case -2:
                    [MessageAlertView showErrorMessage:@"系统异常"];
                    break;
                case -3:
                    [MessageAlertView showErrorMessage:@"网络异常"];
                    break;
                case -4:
                    [MessageAlertView showErrorMessage:@"用户输入错误"];
                    break;
                case -5:
                    [MessageAlertView showErrorMessage:@"商户信息错误"];
                    break;
                default:
                    break;
            }
